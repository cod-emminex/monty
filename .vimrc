...
function! Settings()
    ...
    set t_ut=""                                       "patch, resolve ce color problem https://github.com/microsoft/terminal/issues/832
    ...
    try
        ...
        colorscheme slate | set background=dark      "Iceberg dark
        ""fff
    catch
        colorscheme iceberg
    endtry
